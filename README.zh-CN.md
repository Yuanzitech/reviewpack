...
当前 GitHub Action 集成不会自动评论 PR，也不会调用 AI provider。它只会在 workflow 中生成 `.reviewpack/` 并上传为 artifact。
...
- v0.6.x：GitHub Action UX、配置能力和输出质量
- v0.7.x：配置驱动工作流
- v0.8.x：Review artifact 质量提升
- v0.9.x：GitHub PR workflow 增强
